//var NewApiRootUrl = 'http://140.143.37.22:8080/platform-framework/api/';
var NewApiRootUrl = 'http://192.168.200.86:8080/platform-framework/api/';
//var NewApiRootUrl = 'https://xcx.foooog.cn/api/';

module.exports = {
    GetPoint:NewApiRootUrl+'user/getPoint', //获取用户积分
    Forward: NewApiRootUrl +'transfer/pay', //提现
    ...
    Activity: NewApiRootUrl + 'activity/banner',  //活动页

    GoodsCount: NewApiRootUrl + 'goods/count',  //统计商品总数
    GoodsList: NewApiRootUrl + 'goods/list',  //获得商品列表
    GoodsBanList: NewApiRootUrl + "goods/bannerList",  //获得banner商品列表
